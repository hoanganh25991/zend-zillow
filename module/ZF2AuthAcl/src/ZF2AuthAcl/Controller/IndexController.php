    ...
    public function indexAction(){
        ...
        if($request->isPost()){
            ...
            if($loginForm->isValid()){
                ...
                $authService->getAdapter()->setIdentity($data['email'])
                ...
                if($result->isValid()){
                    ...
                    $session->offsetSet('roleName',
                        $userDetails[0]['role_name']);
...
//                    ));
                ...
                return $this->redirect()->toUrl('/arvind2110-login');
//                else{
////                    $this->flashMessenger()->addMessage(array(
...
//                    return $this->redirect()->toUrl('/arvind2110-login');
//                }
//                return $this->redirect()->tourl('/task');
